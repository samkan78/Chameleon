...
export const BoxComponent: React.FC<BoxComponentProps> = ({ onContinue }) => {
  ...
  const threeChameleons: Chameleon[] = [
    {
      ...
      image: "src/assets/chameleons/panther-green.png",
    },
    {
      ...
      image: "src/assets/chameleons/jackson-green.png",
    },
    {
  ...
  const goRight = () => {
    // function to go to the next chameleon
    setcurrentChameleonPos((prevPos) => (prevPos + 1) % threeChameleons.length);
  };
  const goLeft = () => {
    // function to go to the previous chameleon
  ...
  return (
    <div className="box-container">
      ...
      {/* displays current chameleon name and description */}
